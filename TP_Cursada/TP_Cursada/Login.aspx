...
<div>
    ...
    <asp:TextBox ID="tbUsuario" runat="server" cssclass="form-control" Width="190px"></asp:TextBox>
    <br />
...
<div class="form-group">
    ...
    <asp:TextBox ID="tbPassword" runat="server" cssclass="form-control" Width="190px" Type="Password"></asp:TextBox>
    <br />
